...
for season in range(len(seasons)):
  ...
  intensity_grid.to_netcdf("paper/output/PISCOp_h_intensity_" + "_".join(seasons[season]) + ".nc")
...
for season in range(len(seasons)):
  ...
  intensity_grid.to_netcdf("paper/output/PISCOp_h_non-DBC_intensity_" + "_".join(seasons[season]) + ".nc")
